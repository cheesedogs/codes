...
INSERT INTO `user`(id, username, password) VALUES (1,'root','123456'),(2,'employee','123456'),(3,'test','123456'),(5,'test1','123456'),(7,'test121','123456'),(8,'root2','123456'),(10,'roottt','123123'),(12,'zhourui','123456'),(13,'abc123','abc123'),(15,'dd','123');
UPDATE `user` SET identity='管理员' WHERE id=1;
UPDATE `user` SET identity='员工' WHERE id=2;
UPDATE `user` SET identity='员工' WHERE username='root2';
